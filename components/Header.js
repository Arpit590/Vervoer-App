import { Animated, Dimensions, Image, StyleSheet, Text, TouchableOpacity, View, ScrollView, Modal } from 'react-native'
...
const Header = ({ map }) => {
    ...
    return (
        <>
            <View style={[styles.header, { width: "100%", position: map && "absolute" }]}>
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.8} style={{ marginHorizontal: 20 }}>
                            <Image
                ...
                >
                    <View style={{ alignItems: "center", width: "100%", flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center'  }}>
                        <View style={{padding: 20, backgroundColor: '#fff',  borderRadius: 20, }}>
                        <Text style={{fontSize: 22, color: '#000', fontWeight: '600', alignSelf: 'center'}}>
                            Are you Sure?
                        </Text>
                        <Text style={{fontSize: 22, color: '#000', fontWeight: '600', alignSelf: 'center', textAlign: "center", marginVertical: 10}}>
                            Are you sure you want to logout?
                        </Text>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                            <TouchableOpacity onPress={()=>setModalVisible(!modalVisible)} style={{backgroundColor: '#5E5E60', width: '45%', height: 40, borderRadius: 25, justifyContent: 'center', alignItems: 'center'}}>
                            ...
                            }} style={{backgroundColor: '#F99026', width: '45%', height: 40, borderRadius: 25, justifyContent: 'center', alignItems: 'center'}}>
                                <Text style={{color: '#fff'}}>
                                    Yes
                                </Text>
                            </TouchableOpacity>
