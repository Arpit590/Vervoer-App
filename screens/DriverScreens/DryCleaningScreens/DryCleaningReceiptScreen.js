...
const DryCleaningReceiptScreen = () => {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{zIndex:10,flexDirection:"column",marginTop:20, marginHorizontal:20}}>
                ...
                <View style={{marginTop:30}}>
                    ...
                    style={{backgroundColor:"#5E5E60", padding:15, width:"50%",alignSelf:"center",alignItems:"center",paddingHorizontal:20, borderRadius:30, marginVertical:30}}>
                        <Text style={{fontSize:15, color:"#FFFFFF"}}>New Pickup</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ScrollView>
...
export default DryCleaningReceiptScreen
