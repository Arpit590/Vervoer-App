    ...
    <View style={styles.screen}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{zIndex:10,flexDirection:"column",marginTop:20, marginHorizontal:20}}>
                <View style={{flexDirection:"row", alignItems:"flex-start"}}>
                    ...
                    <View style={{marginLeft:20}}>
                        ...
                        <Text style={{fontSize:12, color:"#808080", marginRight: 10}}>Find and Book Bikes, Scooter, Mopeds, Bicycles near you</Text>
                    </View>
                </View>
            </View>
            <View style={{marginTop:20,paddingHorizontal:20, alignItems:"center", flexDirection:"row", justifyContent:"space-evenly"}}>
                <RoleContainer
                text="Book Now"
                tabHandler="BookMobility"
                tab="BookNow"
                imageUrl={require("../../../assets/microMobilitySVg/bookNowVehicle.png")}
                />
                <RoleContainer
                text="Scan QBR code"
                tab="ScanQBR"
            ...
            <View style={{marginTop:20,paddingHorizontal:20, alignItems:"center", flexDirection:"row", justifyContent:"space-evenly"}}>
                <RoleContainer
                text="Live Session "
                tabHandler="LiveSession"
                tab="LiveSession"
                imageUrl={require("../../../assets/live.png")}
                />
                <RoleContainer
                text="History"
                tabHandler="Micro Mobility History"
                tab="History"
                imageUrl={require("../../../assets/history.png")}
                />
            </View>
            <View style={{backgroundColor: '#EBEBEB', paddingVertical: 40, marginHorizontal: 20, borderRadius: 16}} />
            <View style={{marginHorizontal: 20,marginVertical: 8,}}>
                <Text style={{fontSize: 16, color: '#000'}}>
                Recommendations
                </Text>
                <Image style={{resizeMode: 'contain', width: '100%', marginTop: -130}} source={require("../../../assets/microMobilitySVg/carsharing.png")} />
            </View>
        </ScrollView>
