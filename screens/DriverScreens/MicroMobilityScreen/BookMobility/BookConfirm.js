  ...
  return (
    <View style={styles.screen}>
        ...
        <View style={{position:"absolute", bottom:"0%",maxHeight:500,alignSelf:"center", backgroundColor:"#FFFFFF", padding:10, borderRadius:10, marginTop:20, width:width}}>
            ...
            <Image resizeMode='contain' style={{width: '100%', height: 110, marginVertical: 10 }} source={require('../../../../assets/microMobilitySVg/carsharing.png')} />
            <View>
                <Text style={{color: '#000', fontWeight: '600', marginHorizontal: 20}}>
                    Journey Details
                </Text>
                <Image resizeMode='contain' style={{width: '100%', height: 180, marginVertical: 10 }} source={require('../../../../assets/microMobilitySVg/journeyDetails.png')} />
            </View>
            <View>
                <Text style={{color: '#000', fontWeight: '600', marginHorizontal: 20}}>
                Owner Information
...
export default BookMobilityConfirm;
