    ...
    <View style={styles.screen}>
        ...
        <View style={{position:"absolute", bottom:"0%",maxHeight:500,alignSelf:"center", backgroundColor:"#FFFFFF", padding:10, borderRadius:10, marginTop:20, width:width}}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={{elevation:5,marginVertical:20, flexDirection:"row", alignItems:"center", alignSelf:"center", backgroundColor:"#FFFFFF", borderRadius:30, paddingHorizontal:15, paddingVertical:5}}>
                    <TouchableOpacity activeOpacity={0.8} 
                    onPress={carHandler}
                    style={{flexDirection:"row", alignItems:"center", backgroundColor:(click==="For Car") ? "#FDF1E5" : "transparent", paddingVertical:8, paddingHorizontal:10, borderRadius:30}}>
                        <Image
                        source={require("../../../../assets/microMobilitySVg/bike1.png")}
                        style={{height:30, width: 30, resizeMode:"contain", marginRight:10}}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                    onPress={bikeHandler}
                    activeOpacity={0.8} style={{flexDirection:"row", alignItems:"center",marginLeft:10,backgroundColor:(click==="For Bike") ? "#FDF1E5" : "transparent", paddingVertical:8, paddingHorizontal:15, borderRadius:30}}>
                        <Image
                        source={require("../../../../assets/microMobilitySVg/bike2.png")}
                        style={{height:30, width: 30, resizeMode:"contain", marginRight:10}}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity activeOpacity={0.8} 
                    onPress={carHandler}
                    style={{flexDirection:"row", alignItems:"center",paddingVertical:8, paddingHorizontal:15, borderRadius:30}}>
                        <Image
                        source={require("../../../../assets/microMobilitySVg/bike3.png")}
                        style={{height:30, width: 30, resizeMode:"contain", marginRight:10}}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                    onPress={bikeHandler}
                    activeOpacity={0.8} style={{flexDirection:"row", alignItems:"center",marginLeft:10, paddingVertical:8, paddingHorizontal:15, borderRadius:30}}>
                        <Image
                        source={require("../../../../assets/microMobilitySVg/bike4.png")}
                        style={{height:30, width: 30, resizeMode:"contain", marginRight:10}}
                        />
                    </TouchableOpacity>
                </View>
                <TouchableOpacity onPress={() => setBike(prev => !prev)}>
                {bike ? <Image resizeMode='contain' style={{width: '100%', height: 110, marginVertical: 10 }} source={require('../../../../assets/microMobilitySVg/carsharing.png')} /> :
                <Image resizeMode='contain' style={{width: '100%', height: 110, marginVertical: 10 }} source={require('../../../../assets/microMobilitySVg/carsharing1.png')} />}
                </TouchableOpacity>

                {!bike && <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                    <TouchableOpacity style={{backgroundColor: '#707070', borderRadius: 30, width: '45%', justifyContent: 'center',alignItems: 'center'}}>
                        <Text style={{color: '#fff', padding: 10}}>
                            View Details
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('BookMobilityConfirm')} style={{backgroundColor: '#F99026', borderRadius: 30, width: '45%', justifyContent: 'center',alignItems: 'center'}}>
                        <Text style={{color: '#fff', padding: 10}}>
                            Book Now
                        </Text>
                    </TouchableOpacity>
