...
const RiderContainer = ({name, price, pickupLocation, dropLocation, duration, miles, tip, rideAccepted}) => {
        ...
        style={{marginTop:20,padding:20, backgroundColor:"#FDF1E5", borderRadius:10}}>
            ...
            <View style={{marginVertical:20}}>
                ...
                <View style={{flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
                    <TouchableOpacity 
                    onPress={()=>navigation.navigate("Ride Summary", {"name": name, "price": price, "pickupLocation": pickupLocation, "dropLocation": dropLocation, "miles": miles, "tip": tip, "duration": duration})}
                    activeOpacity={0.8} style={{width:"90%",alignSelf:"center",marginTop:10,backgroundColor:"#F99026", padding:15, borderRadius:30, paddingHorizontal:30}}>
                        <Text style={{fontSize:15, color:"#FFFFFF", fontWeight:"bold", textAlign:"center"}}>Arrived</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                    onPress={()=>navigation.navigate("Cancel Trip", {"cancelledTrip": false})}
                    activeOpacity={0.8} style={{width:"90%",alignSelf:"center",marginTop:10,backgroundColor:"#5E5E60", padding:15, borderRadius:30, paddingHorizontal:30}}>
                        <Text style={{fontSize:15, color:"#FFFFFF", fontWeight:"bold", textAlign:"center"}}>Cancel</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </TouchableOpacity>
        ...
        style={{marginTop:20,padding:20, backgroundColor:(click) ? "#FDF1E5" :"whitesmoke", borderRadius:10}}>
            ...
            <Animated.View style={{display:(click)? "flex": "none",opacity:value, marginVertical:20}}>
                ...
                <View style={{flexDirection:"row", alignItems:"center", justifyContent:"center"}}>
                    <TouchableOpacity 
                    onPress={()=>navigation.navigate("Ride Accepted", {"name": name, "price": price, "pickupLocation": pickupLocation, "dropLocation": dropLocation, "miles": miles, "tip": tip, "duration": duration})}
                    ...
                    activeOpacity={0.8} style={{width:"50%",alignSelf:"center",marginLeft:20,marginTop:10,backgroundColor:"#5E5E60", padding:15, borderRadius:30, paddingHorizontal:30}}>
                        <Text style={{fontSize:15, color:"#FFFFFF", fontWeight:"bold", textAlign:"center"}}>Cancel Ride</Text>
                    </TouchableOpacity>
                </View>
            </Animated.View>
        </TouchableOpacity>
        ...
        visible={isOpen}>
            <View style={{alignItems:"center", width:"90%", flex:1, justifyContent:"center", alignSelf:"center"}}>
                <View style={styles.modal}>
                    <Text style={{fontSize:20, color:"#F99026", textAlign:"center", marginBottom:15, fontWeight:"500"}}>Waiting for the Rider</Text>
                    <Text style={{fontSize:14, color:"#808080", marginBottom:15, textAlign:"center", maxWidth:300, alignSelf:"center"}}>
                        If the Rider does not arrive in 5 minutes. The trip will be cancelled automatically.
                    </Text>
                    ...
                    <TouchableOpacity 
                    onPress={()=>{
                        navigation.navigate("Cancel Trip", {"cancelledTrip": true, "purpose": "Rider"});
                        setIsOpen(false)
                        }}
                    activeOpacity={0.8} style={{width:"85%",alignSelf:"center",marginTop:20,backgroundColor:"#5E5E60", padding:15, borderRadius:30, paddingHorizontal:30}}>
                        <Text style={{fontSize:15, color:"#FFFFFF", fontWeight:"bold", textAlign:"center"}}>Cancel Trip</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
