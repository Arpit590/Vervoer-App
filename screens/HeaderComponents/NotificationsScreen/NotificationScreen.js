            ...
            <View style={{zIndex:10,flexDirection:"column",marginTop:20, marginHorizontal:20}}>
                <View style={{flexDirection:"row", alignItems:"flex-start"}}>
                    ...
                    <View style={{marginLeft:20}}>
                        <Text style={{fontSize:16, color:"#000000", marginBottom:5}}>Notifications</Text>
                    </View>
                </View>
                <View style={{marginVertical:20}}>
                    <View style={{}}>
                        <Text style={{fontSize:15, color:"#000000", marginBottom:5}}>
                            Lorem ipsum dolor sit amet constetur sapdicing eleirt sed diam nonumy temopor invidunt ut
                        </Text>
                        <Text style={{fontSize:12, color:"#808080"}}>5 min ago</Text>
                    </View>
