            ...
            <View style={{zIndex:10,flexDirection:"column",marginTop:20, marginHorizontal:20}}>
                <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                    <View style={{flexDirection:"row", alignItems:"flex-start"}}>
                        ...
                        <View style={{marginLeft:10}}>
                            ...
                            ?
                            <Text style={{fontSize:18, color:"#000000", marginBottom:5}}>Withdrew</Text>
                            :
                            <Text style={{fontSize:18, color:"#000000", marginBottom:5}}>Deposited</Text>
                            }
                        </View>
                    </View>
                ...
                <View style={{marginVertical:20}}>
                    <View style={{backgroundColor:"#FFFFFF", padding:20, borderRadius:20}}>
                        <Text style={{fontSize:25, color:"#000000", marginBottom:20, textAlign:"center"}}>${route.params.price}</Text>
                        {(route.params.withdrew)
                        ?
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>To Bank</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.bankName}</Text>
                        </View>
                        :
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>Payment Method</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.paymentMethod}</Text>
                        </View>
                        }
                        {(route.params.withdrew)
                        ?
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>Bank Acc Number</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.accountNumber}</Text>
                        </View>
                        :
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>Card Number</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.accountNumber}</Text>
                        </View>
                        }
                        {(route.params.withdrew) 
                        &&
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>IFSC Number</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.IFSC}</Text>
                        </View>
                        }
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>Acc Holder Name</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.name}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:15, marginBottom:20}}>
                            <Text style={{fontSize:15, color:"#000000"}}>Date & Time</Text>
                            <Text style={{fontSize:15, color:"#000000"}}>{route.params.timestamp}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between",paddingBottom:15}}>
                            <Text style={{fontSize:15, color:"#000000"}}>TXID</Text>
                            <Text style={{fontSize:15, color:"#F99026", fontWeight:"bold"}}>{route.params.TXID}</Text>
                        </View>
                    </View>
                </View>
            </View>
        </ScrollView>
        <View style={{position:"absolute", bottom:"3%", width:"100%", flexDirection:"row", alignItems:"center", justifyContent:"center"}}>
            <TouchableOpacity activeOpacity={0.8} style={{backgroundColor:"#5E5E60", padding:20, borderRadius:30, width:"45%",alignItems:"center"}}>
                <Text style={{fontSize:15, color:"#FFFFFF"}}>Report</Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.8} style={{backgroundColor:"#F99026", marginLeft:10,padding:20, borderRadius:30, width:"45%",alignItems:"center"}}>
                <Text style={{fontSize:15, color:"#FFFFFF"}}>Copy TXID</Text>
            </TouchableOpacity>
        </View>
