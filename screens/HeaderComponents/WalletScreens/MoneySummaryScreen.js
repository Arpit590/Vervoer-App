  ...
  return (
    <View style={styles.screen}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{zIndex:10,flexDirection:"column",marginTop:20, marginHorizontal:20}}>
                <View style={{flexDirection:"row", alignItems:"flex-start", justifyContent:"space-between"}}>
                    <View style={{flexDirection:"row", alignItems:"flex-start"}}>
                        ...
                        <View style={{marginLeft:10}}>
                            ...
                            ?
                            <Text style={{fontSize:18, color:"#000000", marginBottom:5}}>Withdraw Summary</Text>
                            :
                            <Text style={{fontSize:18, color:"#000000", marginBottom:5}}>Deposit Summary</Text>
                            }        
                        </View>
                    </View>
                </View>
                <View style={{marginVertical:20}}>
                    {(route.params.withdraw) 
                    ?
                    <View style={{backgroundColor:"#FFFFFF", padding:20, paddingVertical:50,borderRadius:10}}>
                        <Text style={{fontSize:25, color:"#000000", marginBottom:20, textAlign:"center"}}>$500.00</Text>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:10, marginBottom:20}}>
                            <Text style={{fontSize:16, color:"#000000"}}>To Bank</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.bankName}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:10, marginBottom:20}}>
                            <Text style={{fontSize:16, color:"#000000"}}>Bank Acc Number</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.accountNumber}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:10, marginBottom:20}}>
                            <Text style={{fontSize:16, color:"#000000"}}>IFSC Number</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.IFSC}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                            <Text style={{fontSize:16, color:"#000000"}}>Acc Holder Name</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.name}</Text>
                        </View>
                    </View>
                    :
                    <View style={{backgroundColor:"#FFFFFF", padding:20, paddingVertical:50,borderRadius:10}}>
                        <Text style={{fontSize:25, color:"#000000", marginBottom:20, textAlign:"center"}}>$500.00</Text>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:10, marginBottom:20}}>
                            <Text style={{fontSize:16, color:"#000000"}}>Payment Method</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.paymentMethod}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", borderBottomColor:"#808080", borderBottomWidth:1, paddingBottom:10, marginBottom:20}}>
                            <Text style={{fontSize:16, color:"#000000"}}>Card Number</Text>
                            <Text style={{fontSize:16, color:"#808080"}}>{route.params.accountNumber}</Text>
                        </View>
                        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                            <Text style={{fontSize:16, color:"#000000"}}>Acc Holder Name</Text>
        ...
        <View style={{position:"absolute", bottom:"0%", width:"100%", paddingVertical:10}}>
            <TouchableOpacity 
            onPress={()=>navigation.navigate("Money Success", {"withdraw": route.params.withdraw,"accountNumber": route.params.accountNumber, "bankName": route.params.bankName, "name": route.params.name, "IFSC": route.params.IFSC})}
        ...
        <View style={{position:"absolute", bottom:"0%", width:"100%", paddingVertical:10}}>
            <TouchableOpacity
             onPress={()=>navigation.navigate("Money Success", {"withdraw": route.params.withdraw,"accountNumber": route.params.accountNumber, "paymentMethod": route.params.paymentMethod, "name": route.params.name})}
            activeOpacity={0.8} style={{backgroundColor:"#F99026", marginVertical:10, alignSelf:"center",padding:20, borderRadius:30, width:"85%",alignItems:"center"}}>
                <Text style={{fontSize:15, color:"#FFFFFF"}}>Add Money Now</Text>
            </TouchableOpacity>
        </View>
        }
...
export default MoneySummaryScreen
