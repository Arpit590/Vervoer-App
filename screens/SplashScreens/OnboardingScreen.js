    ...
    <View style={styles.screen}>
      <View style={{paddingHorizontal:10, paddingTop:20}}>
        ...
        <View style={{paddingLeft:20}}>
          <Animated.Text style={{fontSize:25, color:"#000000", left:value}}>Rides, Parking</Animated.Text>
          <Animated.Text style={{fontSize:25, color:"#000000", left:value1}}>& Dry Cleaning</Animated.Text>
          <Animated.Text style={{fontSize:25, color:"#000000", left:value2}}>in an Instant!</Animated.Text>
        </View>
      </View>
      <Animated.View style={{opacity:value3}}>
        <Image
        source={require("../../assets/Car.png")}
        style={{height:300, width:width, resizeMode:"contain", marginVertical:100}}
        />
      </Animated.View>
      <View style={{position:"absolute", bottom:0, right:0}}>
        ...
        style={{flexDirection:"row", alignItems:"center", position:"absolute", zIndex:100, bottom:20,right:20}}>
          <Text style={{fontSize:15, color:"#FFFFFF", fontWeight:"bold", marginRight:5}}>Get Started</Text>
          <MaterialIcons
