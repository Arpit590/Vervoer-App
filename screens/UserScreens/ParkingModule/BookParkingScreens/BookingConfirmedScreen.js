  ...
  return (
    <View style={styles.screen}>
        <View style={styles.container}>
            ...
            />
            <Text style={{fontSize:20, fontWeight:"bold",color:"#000000", marginTop:20, marginBottom:40}}>Book Successfully</Text>
            <Text style={{fontSize:15, color:"#808080", marginBottom:30}}>Your Car Is Saved</Text>
            <TouchableOpacity 
