      ...
      <View style={{ paddingHorizontal: 10, paddingTop: 20 }}>
        <View style={{ padding: 20 }}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 50 }}>
            ...
            <Text style={{ fontSize: 15, color: "#000000", textAlign: "center", marginBottom: 20 }}>Your Email is verified successfully.</Text>
          </ScrollView>
        </View>
      </View>
      <TouchableOpacity
...
export default VerifiedWithEmailScreen
